...
public class APINode {
	...
	public static void run(String packageName,String projectId,String serviceApiUrl)   {
		Set<Class<?>> clas;
		try {
			clas = getClasses(packageName);
			...
			HttpRequest.postRequest(serviceApiUrl, jo.toString());
